        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">LivrEat</h1>
                        <h2 class="home__subtitle">Fresh. Fast. Delicious.</h2>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial">Le Meilleurs c'est chez <br> LivrEat</h2>
                        <p class="about__description">Chez LivrEat, nous sommes passionés par la nourriture de qualité et nous nous engageons à offrir une expérience de livraison de nourriture rapide, pratique et fiable pour nos clients. Nous croyons que la nourriture doit être savoureuse, saine et abordable, et nous travaillons dur pour offrir des plats qui repondent à ces critères.</p>
                        <a href="contact.html" class="button">Nous Conctatez</a>
                    </div>
            ...
            <section class="services section bd-container" id="services">
                ...
                <div class="services__container  bd-grid">
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Excellent</h3>
                        <p class="services__description">Nous offrons à nos clients des services d'excllente qualité depuis de nombreux années, avec les meilleurs et les delicieux plats de chez nous.</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Fresh</h3>
                        <p class="services__description">Nous offrons à nos clients des services d'excllente qualité depuis de nombreux années, avec les meilleurs et les delicieux plats de chez nous.</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <p class="services__description">Nous offrons à nos clients un service de qualité et très rapide, soyez livrer quelque minutes après votre commande.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="menu section bd-container" id="menu">
                ...
                <div class="menu__container bd-grid">
                    ...
                    <a href="menu.html" class="button">Voir plus...</a>
                </div>
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    <div class="contact__data">
                        <span class="section-subtitle contact__initial">Parlons en !</span>
                        <h2 class="section-title contact__initial">Contact</h2>
                        <p class="contact__description"> Si vous souhaitezcommander des delicieux plats, contatez nous et vous assisterons rapidement, disponible 24/7.</p>
                    </div>

                    <div class="contact__button">
                        <a href="contact.html" class="button">Conctatez</a>
                    </div>
                </div>
            </section>
        </main>
